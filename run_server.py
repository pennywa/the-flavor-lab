...
import os
import requests # Needed for Pexels API
...
import socketserver
import webbrowser
# import os is already present above
...
class MyHTTPRequestHandler(http.server.SimpleHTTPRequestHandler):
    ...
    # --- MISSING METHOD: handle_api_request (Gemini Logic) ---
    def handle_api_request(self):
        ...
        try:
            ...
            # Extract the custom prompt and model name from the client
